          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">
                PropOS <span className="text-orange-400">Technician</span>
              </h1>
          ...
          <div className="bg-red-900/30 border border-red-500 p-4 rounded-xl flex items-center gap-3 animate-pulse">
            ...
            <div>
              <p className="font-bold text-red-300">
                ...
                {stats.emergency > 1 ? "s" : ""} — Needs Immediate Attention!
              </p>
            </div>
          </div>
        )}
          ...
          {filtered.length > 0 ? (
            filtered.map((ticket) => {
              ...
              return (
                <div
                  key={ticket.id}
                  className={`rounded-xl border ${style.bg} overflow-hidden transition-all`}
                >
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex items-center gap-2 shrink-0 ml-3">
                        <span
                          className={`px-2 py-1 rounded-md text-[10px] font-bold border ${style.badge}`}
                        >
                          {ticket.priority}
                        </span>
                        {isExpanded ? (
                    ...
                    <div className="flex items-center gap-4 text-xs text-gray-400">
                      <span className="flex items-center gap-1">
                        <Building size={12} /> {ticket.property_name} — Unit{" "}
                        {ticket.unit_number}
                      </span>
                      <span className="flex items-center gap-1">
                        <Clock size={12} />{" "}
                    ...
                    <div className="border-t border-gray-700/50 p-4 space-y-4 bg-gray-900/30">
                        ...
                        <div className="bg-gray-800 p-3 rounded-lg border border-gray-700">
                          ...
                          {ticket.tenant_phone && (
                            <a
                              ...
                              className="text-xs text-blue-400 ml-4 flex items-center gap-1 mt-1 hover:text-blue-300"
                            >
                      ...
                      {ticket.resolution_notes && (
                        <div className="bg-green-900/20 border border-green-500/30 p-3 rounded-lg">
                          <p className="text-[10px] text-green-400 uppercase font-bold mb-1">
                            Resolution Notes
                          </p>
                          <p className="text-sm text-gray-300">
                            {ticket.resolution_notes}
